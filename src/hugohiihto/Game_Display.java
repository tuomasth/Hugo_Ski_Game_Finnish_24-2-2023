...
public final class Game_Display extends JPanel{
    final static String VERSION = "1.0.0.4"; 
    final static int GAMESPEED = 1620;      // in milliseconds 
    ...
    */
                     ...
                     */
                      public void run() {
                        ...
                        if(!gamePaused) {
                            ...
                            //
                            if(currentHazardOrMoney1_y_position < 165) {
                                currentHazardOrMoney1_y_position++;
                            }
                        }
                        if(currentHazardOrMoney1_y_position > d.getHeight()-240) {
                ...
                Thread HAZ2 = new Thread() {
                     ...
                     */
                      public void run() {
                        ...
                        if(currentHazardOrMoney2_y_position > d.getHeight()-240) {
                ...
                Thread HAZ3 = new Thread() {
                     ...
                     */
                      public void run() {
                        ...
                        if(currentHazardOrMoney3_y_position > d.getHeight()-240) {
                ...
                Thread HAZ4 = new Thread() {
                     ...
                     */
                      public void run() {
                        ...
                        if(currentHazardOrMoney4_y_position > d.getHeight()-240) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> { // lambda expression, https://www.w3schools.com/java/java_lambda.asp
            try {
                System.out.println("Hugo Skiing, Nov-8-2023, GAME SPEED (ms): " + GAMESPEED);
